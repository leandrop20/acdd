    	...
    	<div class="col-md-3">
            <form method="POST">
        		<div class="input-group h2">
        			<input name="id" class="form-control" id="search" type="text" placeholder="Buscar pelo CIA" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
    ...
    <div id="list" class="row">
    	<div class="table-responsive col-md-12">
    		<table class="table table-striped" cellspacing="0" cellpadding="0">
            	<thead>
                	<tr>
                        <th><a href="#" onclick="order('id')">CIA</a></th>
                        <th><a href="#" onclick="order('ficha')">Ficha</a></th>
                   		<th><a href="#" onclick="order('nome')">Nome</a></th>
                   		<th><a href="#" onclick="order('nome_da_mae')">Nome da mãe</a></th>
                   		<th>Telefone</th>
            	...
            	<tbody>
	    			...
	    			<tr>
                        ...
                        <td><?= $data->data[$i]['ficha']; ?></td>
	    				<td><?= $data->data[$i]['nome']; ?></td>
	    				<td><?= $data->data[$i]['nome_da_mae']; ?></td>
	    				...
	    				<td class="actions">
                            ...
                            <?php
                            if ($assistidos->checkPresence($data->data[$i]['id'])) {

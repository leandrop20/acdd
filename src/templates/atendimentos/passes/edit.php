...
<!-- Modal search Medium -->
<div class="container">
	<h3>Editar Cadastro de Passe</h3>
	<form method="post">
		<hr />
		<div class="row">
			<div class="form-group col-md-4">
   				...
   				<select name="id_assistido" class="form-control" id="field1" disabled>
   					<option value="10"><?= $data->nomeAssistido; ?></option>
   				</select>
 			</div>
 			<div class="form-group col-md-4">
          ...
          <input name="data_passe" type="text" class="form-control" id="field3" value="<?= date('d/m/Y', strtotime(str_replace('/', '-', $data->data['data_passe']))); ?>" disabled>
 			</div>
 			<div class="form-group col-md-4">

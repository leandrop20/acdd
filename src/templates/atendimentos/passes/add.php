          ...
          <div class="input-group">
            ...
            <span class="input-group-btn">
 			...
 			<div class="form-group col-md-2">
   				<label for="field3">Data do Passe</label>
                <div class="input-group date" id="datepicker">
                    <input name="data_passe" type="text" class="form-control" id="field3" required>
 			...
 			<div class="form-group col-md-3">
   				...
   				<!-- <input name="status" type="radio" class="form-control" id="field5" value=""><?= STATUS[0]; ?> -->
   				<!-- <input name="status" type="radio" class="form-control" id="field5" value=""><?= STATUS[1]; ?> -->
   				<div class="radio">

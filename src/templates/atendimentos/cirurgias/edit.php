...
<!-- Modal search Medium -->
<div class="container">
	<h3>Editar Cadastro de Cirurgia</h3>
	<form method="post">
		<hr />
		<div class="row">
          ...
          <div class="input-group">
            ...
            <span class="input-group-btn">
 			...
 			<div class="form-group col-md-2">
   				<label for="field3">Data da Cirurgia</label>
          <input name="data_cirurgia" type="text" class="form-control" id="field3" value="<?= date('d/m/Y', strtotime(str_replace('/', '-', $data->data['data_cirurgia']))); ?>" disabled>
 			</div>
 			<div class="form-group col-md-4">

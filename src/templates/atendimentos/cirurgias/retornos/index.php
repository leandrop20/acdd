...
<div class="container">
	<div id="top" class="row">
        ...
        <div class="col-md-3">
            <form method="POST">
                <div class="input-group h2">
                    <input name="id_cirurgia" class="form-control" id="search" type="text" placeholder="Buscar por Cód. da Cirurgia" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
    		...
    		<table class="table table-striped" cellspacing="0" cellpadding="0">
            	<thead>
                	<tr>
                		...
                		<th><a href="#" onclick="order('id_cirurgia')">Cód. da Cirurgia</a></th>
               	...
               	<tbody>
	    			...
	    			<tr>
	    				...
	    				<td><?= substr($idNums, strlen($data->data[$i]['id_cirurgia']), 6).$data->data[$i]['id_cirurgia']; ?></td>
     	...
     	<div class="col-md-12 text-center">
     		<ul class="pagination">
                ...
                <form id="formPag" method="POST">
                    ...
                    <?php if (isset($_POST['id_cirurgia'])) { echo "<input name='id_cirurgia' type='hidden' value='".$_POST['id_cirurgia']."'>"; } ?>

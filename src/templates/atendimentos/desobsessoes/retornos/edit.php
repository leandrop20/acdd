...
<!-- Modal search Medium -->
<div class="container">
	<h3>Editar Retorno de Desobsessão</h3>
	<form method="post">
		<hr />
		<div class="row">
			<div class="form-group col-md-2">
   				<label for="field1">Cód. da Desob.</label>
          <input name="id_desobsessao" type="text" class="form-control" id="field1" value="<?= substr($idNums, strlen($data->data['id']), 6).$data->data['id']; ?>" disabled>
 			</div>

...
<div class="container">
	<div id="top" class="row">
        ...
        <div class="col-md-3">
            <form method="POST">
                <div class="input-group h2">
                    <input name="id_desobsessao" class="form-control" id="search" type="text" placeholder="Buscar por Cód. da Desob" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
        ...
        <div class="col-md-2">
            <a href="../index" class="btn btn-primary pull-right h2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Novo Cadastro</a>
        </div>
    </div> <!-- /#top -->
    <hr />
    		...
    		<table class="table table-striped" cellspacing="0" cellpadding="0">
            	<thead>
                	<tr>
                		...
                		<th><a href="#" onclick="order('id_desobsessao')">Cód. da Desob.</a></th>
                		<th><a href="#" onclick="order('nomeAssistido')">Assistido</a></th>
                		<th><a href="#" onclick="order('nomeTrabalhador')">Médium</a></th>
                		<th><a href="#" onclick="order('data_retorno')">Data do Retorno</a></th>
               	...
               	<tbody>
	    			...
	    			<tr>
	    				...
	    				<td><?= substr($idNums, strlen($data->data[$i]['id_desobsessao']), 6).$data->data[$i]['id_desobsessao']; ?></td>
	    				<td><?= $data->data[$i]['nomeAssistido']; ?></td>
                        <td><?= $data->data[$i]['nomeTrabalhador']; ?></td>
	    				<td><?= date('d/m/Y', strtotime(str_replace('/', '-', $data->data[$i]['data_retorno']))); ?></td>
	    				<td class="actions">
     	...
     	<div class="col-md-12 text-center">
     		<ul class="pagination">
                ...
                <form id="formPag" method="POST">
                    ...
                    <?php if (isset($_POST['id_desobsessao'])) { echo "<input name='id_desobsessao' type='hidden' value='".$_POST['id_desobsessao']."'>"; } ?>

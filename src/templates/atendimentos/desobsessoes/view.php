...
?>
<div class="container">
	<h3>Desobsessão Cód: <?= substr($idNums, strlen($data->data['id']), 6).$data->data['id']; ?></h3>
	<div class="row">
		<div class="col-md-4">
		...
		<div class="col-md-4">
 			<p><strong>Data da Desobsessão</strong></p>
 			<p><?= date('d/m/Y', strtotime(str_replace('/', '-', $data->data['data_desobsessao']))); ?></p>
		</div>

...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Deseja realmente cancelar esta saída?</div>
...
<div class="container">
    <div id="top" class="row">
        ...
        <div class="col-md-3">
            <form method="POST">
                <div class="input-group h2">
                    <input name="id_lote" class="form-control" id="search" type="text" placeholder="Buscar por Cód. do Lote" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
        ...
        <div class="col-md-3">
            <form method="POST">
                <div class="input-group h2">
                    <input name="id_medicamento" class="form-control" id="search" type="text" placeholder="Buscar por Cód. do Med." pattern="[0-9]+" title="apenas números!" maxlength="10" required>
                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
        ...
        <div class="col-md-2">
            <a href="add" class="btn btn-primary pull-right h2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Nova Saída</a>
        </div>
    </div> <!-- /#top -->
    <hr />
        	...
        	<table class="table table-striped" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                    	...
                    	<th><a href="#" onclick="order('id_lote')">Cód. do Lote</a></th>
                    	<th>Qtd.</th>
                    	<th><a href="#" onclick="order('data_saida')">Saída em</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td><?= substr($idNums, strlen($data->data[$i]['id_lote']), 6).$data->data[$i]['id_lote']; ?></td>
                    	<td><?= $data->data[$i]['quantidade']; ?></td>
                    	<td><?= date('d/m/Y', strtotime(str_replace('/', '-', $data->data[$i]['data_saida']))); ?></td>
                    	<td class="actions">
    	...
    	<div class="col-md-12 text-center">
            <ul class="pagination">
                ...
                <form id="formPag" method="POST">
                    ...
                    <?php if (isset($_POST['id_lote'])) { echo "<input name='id_lote' type='hidden' value='".$_POST['id_lote']."'>"; } ?>

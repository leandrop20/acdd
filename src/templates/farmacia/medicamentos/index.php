                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="../lotes/add/<?= $data->data[$i]['id']; ?>" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Lote</a>
                            <a href="../saidas/add/<?= $data->data[$i]['id']; ?>" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span> Saída</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>

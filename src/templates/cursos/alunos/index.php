...
<div class="container">
    <div id="top" class="row">
        <div class="col-md-4">
            <h3>Alunos -</h3><h4><?= $data->nomeCurso; ?> - <?= $data->nomeGrupo; ?></h4>
        </div>
        <div class="col-md-3">
            <form method="POST">
        ...
        <div class="col-md-3">
            <form method="POST">
                <div class="input-group h2">
                    <input name="id_assistido" class="form-control" id="search" type="text" placeholder="Buscar por CIA" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
                    <span class="input-group-btn">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-search"></span>
                        </button>
        ...
        <div class="col-md-2">
            <a href="../add/<?= $ID; ?>" class="btn btn-primary pull-right h2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Novo Aluno</a>
        </div>
    </div> <!-- /#top -->
    <hr />
        	...
        	<table class="table table-striped" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                    	...
                    	<th><a href="#" onclick="order('nomeAssistido')">Nome</a></th>
                        <th><a href="#" onclick="order('nomeTrabalhador')">Instrutor</a></th>
                    	<th>Faltas</th>
                    	<th><a href="#" onclick="order('situacao')">Situação</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td><?= $cursAlunos->getFaltas($ID, $data->data[$i]['id']); ?></td>
                    	<td><?= STATUS_CURSE[$data->data[$i]['situacao']]; ?></td>
                    	<td class="actions">

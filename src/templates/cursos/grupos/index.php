...
$cursGrupos = new CursGruposController();

$data = $cursGrupos->result;
$idNums = "000000";
?>
<!-- Modal -->
...
<div class="container">
    <div id="top" class="row">
        ...
        <div class="col-md-3">
            <a href="add" class="btn btn-primary pull-right h2"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Novo Grupo</a>
        </div>
    </div> <!-- /#top -->
    <hr />
        	...
        	<table class="table table-striped" cellspacing="0" cellpadding="0">
                <thead>
                    <tr>
                    	...
                    	<th><a href="#" onclick="order('nome')">Grupo</a></th>
                    	<th><a href="#" onclick="order('nomeCurso')">Nome do Curso</a></th>
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td><?= $data->data[$i]['nomeCurso']; ?></td>
                        <td><?= $data->data[$i]['nomeTrabalhador']; ?></td>
                    	<td><?= $data->data[$i]['qtdAlunos']; ?></td>
                    	<td class="actions">
                            ...
                            <a href="../alunos/index/<?= $data->data[$i]['id']; ?>" class="btn btn-primary btn-xs">Alunos</a>
                            <a href="../aulas/index/<?= $data->data[$i]['id']; ?>" class="btn btn-primary btn-xs">Aulas</a>
                    	</td>
                    </tr>
                    <?php } ?>
                </tbody>

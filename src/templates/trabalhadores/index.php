...
<div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Deseja realmente excluir este cadastro?</script></div>
...
<div class="container">
	<div id="top" class="row">
    	...
    	<div class="col-md-3">
            <form method="POST">
        		<div class="input-group h2">
        			<input name="id" class="form-control" id="search" type="text" placeholder="Buscar pelo CIT" pattern="[0-9]+" title="apenas números!" maxlength="10" required>
    	...
    	<div class="col-md-3">
            ...
            <?php } else { ?>
            <a class="btn btn-primary pull-right h2 disabled"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Novo Cadastro</a>
            <?php } ?>
    	</div>
	</div> <!-- /#top -->
	<hr />
				...
				<tbody>
					...
					<tr>
	    				...
	    				<td class="actions">
                            ...
                            ?>
                            <a class="btn btn-warning btn-xs disabled"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                            <a class="btn btn-danger btn-xs disabled"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                            <?php
                            }
                            if ($trabalhadores->checkPresence($data->data[$i]['id'])) {
                                echo "<a class='btn btn-success btn-xs' href='setPresence/".$data->data[$i]['id']."'><span class='glyphicon glyphicon-ok' aria-hidden='true'></span> Presença</a>";
                            } else { 
                                echo "<a class='btn btn-default btn-xs' href='setPresence/".$data->data[$i]['id']."'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span> Presença</a>";
                            }
                            ?>
	    				</td>
					</tr>
